...
class MultiAgentChat(View):
    def __init__(self, 
        ...
        python_agent_prompt = '''
        Nextpy is a new web framework, a user will first submit a query, to which another agent called the Retrival Augmented Nextpy Agent will respond.
        Include the entire documentation previously generated by the Retrieval Augmented Nextpy Agent in the CONVERSATION in your response, and make changes/add information wherever necessary.
        If the documentation for the given query does not exist, simply apologize and ask the user to rephrase the query or provide alternatives.
        '''
